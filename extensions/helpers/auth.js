...
const getAdminTokens = (database) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let adminId = "";
    try {
        const cachedToken = yield (0, cache_1.getCacheValue)(global_1.ADMIN_ACCESS_TOKEN_CACHE_KEY);
        const cachedId = yield (0, cache_1.getCacheValue)(global_1.ADMIN_ID_CACHE_KEY);
